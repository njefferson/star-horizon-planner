...
const CACHE = 'horizon-v15'; // WIP: target thumbnails + richer details page (curve/coords/description) (unreleased)
const ASSETS = [
  ...
  './src/ui/targets.js', './src/ui/settings.js', './src/ui/horizoneditor.js', './src/ui/nightgraph.js', './src/ui/sites.js', './src/ui/polar.js', './src/ui/capture.js', './src/ui/livecapture.js', './src/ui/targetdetail.js',
  './src/model/astro.js', './src/model/instruments.js', './src/model/catalog.js', './src/model/horizon.js',
  './src/model/night.js', './src/model/visibility.js', './src/model/sites.js', './src/model/polar.js', './src/model/capture.js', './src/model/arproject.js', './src/model/thumbnails.js', './src/model/describe.js',
